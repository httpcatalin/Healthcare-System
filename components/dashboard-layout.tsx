...
import { Mail, IdCard, Linkedin, CircleUser } from "lucide-react";
...
export function DashboardLayout() {
            ...
            return (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  Your healthcare resource management system is ready. Navigate
                  using the sidebar to access different features.
                </p>
              </div>
            );
        }
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-background">
